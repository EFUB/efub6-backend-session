...
public class FollowService {
    ...
    public FollowStatusResponse unfollow(Long requesterId, Long targetId){
        ...
        Follow follow = getFollow(requester, target); //find는 값이 없을수도 있는 것 / get은 값이 있다는 것이 암묵적으로 내포되어 있음. 예외처리를 해서라도 값이 없는 경우는 제외해야함
    ...
    public FollowListResponse getFollowList(Long requesterId){
        ...
        //가져온 follow 객체에서 follower, followee만 추출해 리스트로 생성
